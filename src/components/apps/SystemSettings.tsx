  ...
  return (
    <div>
      ...
      <Card>
        ...
        <Row label="Region">
          <span style={{ fontSize: "12px", color: dark ? "rgba(255,255,255,0.5)" : "rgba(0,0,0,0.5)" }}>Nepal</span>
        </Row>
      </Card>
      <SectionTitle>Sharing</SectionTitle>
      <Card>
        <Row label="Computer Name">
          <span style={{ fontSize: "12px", color: dark ? "rgba(255,255,255,0.5)" : "rgba(0,0,0,0.5)" }}>Believe's MacBook Pro</span>
        </Row>
      </Card>
    </div>
  );
